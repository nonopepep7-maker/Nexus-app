Nexus is app where we can enjoy not just one, not just two and not just three app/games. we can enjoy 4 app/games.

The apps are:

1) Memory game (my personal favourite) : In the memory game, we can not only enjoy the game we can increase our memory too just by playing!
   
2) Clock (the time taker) : This take so much efforts and time. But i like how i ended up making this great project.
